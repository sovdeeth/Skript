...
@Since("2.8.0")
public class ExprVectorFromDirection extends SimpleExpression<Vector3d> {

	static {
		Skript.registerExpression(ExprVectorFromDirection.class, Vector3d.class, ExpressionType.PROPERTY,
